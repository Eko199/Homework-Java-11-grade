package RealHomework2.Week23.MyLinkedList;
...
public class TestMyLinkedList {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nDoes the list contain France? " + list.contains("France"));
		System.out.println("Does the list contain Norway? " + list.contains("Norway"));
